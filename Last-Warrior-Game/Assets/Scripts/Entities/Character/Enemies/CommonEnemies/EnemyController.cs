...
{    
    ...
    {
        distanceToPlayer = enemyMovement.DistanceToTargetObject(PlayerController.Instance.transform);
    ...
    protected bool IsPlayerAndEnemyAlive()
    {
        return PlayerController.Instance != null &&
               //PlayerController.Instance.playerHealthSystem != null &&
               PlayerController.Instance.playerHealthSystem.CurrentHealth > 0 &&
    ...
    {
        return lookDirection = enemyMovement.LookDirection(PlayerController.Instance.transform);
    }
    private float HandleDistanceToPlayer()
    {
        return distanceToPlayer = enemyMovement.DistanceToTargetObject(PlayerController.Instance.transform);
    }
